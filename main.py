...
#     <li><a href="{{ item.url }}" class="{{ 'active' if item.is_active else '' }}">{{ item.name }}</a></li>
#     {% endfor %}
# </ul>
# """
# menu_items = [
#     {"name": "Главная", "url": "/index", "is_active": True},
#     {"name": "Новости", "url": "/news", "is_active": False},
#     {"name": "О компании", "url": "/about", "is_active": False},
#     {"name": "Магазин", "url": "/shop", "is_active": False},
#     {"name": "Контакты", "url": "/contacts", "is_active": False},
# ]
#
# tm = Template(html)
